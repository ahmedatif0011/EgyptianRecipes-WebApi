...
namespace App.Infrastructure.Reposiotries.Configuration
{
    public class RepositoryQueryMaster<T> : IRepositoryQueryMaster<T> where T : class
    {
        ...
        public RepositoryQueryMaster(dbContext _context)
        {
